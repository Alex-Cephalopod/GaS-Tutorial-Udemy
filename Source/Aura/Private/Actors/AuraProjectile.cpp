...
void AAuraProjectile::BeginPlay()
{
	...
	SetLifeSpan(LifeSpan); //destroy the projectile after a certain amount of time (15 seconds by default)
...
{
	//if the projectile has not hit anything and is not the server, play the impact sound and spawn the impact FX
