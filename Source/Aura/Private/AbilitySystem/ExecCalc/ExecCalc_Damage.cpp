...
struct AuraDamageStatics { //this is a raw struct, no need to add a generated body since it wont be used in blueprint
	...
	AuraDamageStatics()
	{
		...
		TagsToCaptureDefs.Add(AuraTags.Attributes_Secondary_CritHitChance, CritHitChanceDef);
		TagsToCaptureDefs.Add(AuraTags.Attributes_Secondary_CritHitDamage, CritHitDamageDef);
		TagsToCaptureDefs.Add(AuraTags.Attributes_Secondary_CritHitResistance, CritHitResistanceDef);

		TagsToCaptureDefs.Add(AuraTags.Attributes_Resistance_Fire, FireResistanceDef);
		TagsToCaptureDefs.Add(AuraTags.Attributes_Resistance_Lightning, LightningResistanceDef);
		TagsToCaptureDefs.Add(AuraTags.Attributes_Resistance_Arcane, ArcaneResistanceDef);
		TagsToCaptureDefs.Add(AuraTags.Attributes_Resistance_Physical, PhysicalResistanceDef);
